...
public class PacketSessionData extends Packet {
    ...
    public ByteBuf fillBuffer(ByteBuf buffer) {
        ...
        buffer.writeFloatLE(this.seasonLinkIdentifier);
        buffer.writeFloatLE(this.weekendLinkIdentifier);
        buffer.writeFloatLE(this.sessionLinkIdentifier);
        ...
        buffer.writeByte(this.brakingAssist);
